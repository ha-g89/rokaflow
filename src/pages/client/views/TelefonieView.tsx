...
import { Phone as PhoneIcon, Layers, CreditCard, Wifi, Search, Plus, Pencil, Trash2, XCircle, StickyNote, History } from 'lucide-react'
            ...
            <Card className="h-full overflow-y-auto">
              <CardContent className="p-5">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-xs text-slate-600">
                  ...
                  {selected.assignedToName && <p className="col-span-2"><span className="text-slate-400">Toegewezen aan</span><br /><span className="font-medium text-slate-800">{selected.assignedToName}</span></p>}
...
export function TelefonieView({ teammates }: { teammates: ClientUserListItem[] }) {
